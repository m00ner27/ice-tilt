...
import { tournamentsReducer, initialState as tournamentsInitialState } from './tournaments/tournaments.reducer';
...
export interface AppState {
  ...
  tournaments: any; // Will be typed properly in tournaments.reducer
}
