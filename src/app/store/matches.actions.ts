...
export const loadMatchesSuccess = createAction('[Matches] Load Matches Success', props<{ matches: Match[] }>());
...
export const loadMatchSuccess = createAction('[Matches] Load Match Success', props<{ match: Match }>());
...
export const loadMatchesBySeasonSuccess = createAction('[Matches] Load Matches By Season Success', props<{ matches: Match[] }>());
...
export const createMatch = createAction('[Matches] Create Match', props<{ matchData: Partial<Match> }>());
export const createMatchSuccess = createAction('[Matches] Create Match Success', props<{ match: Match }>());
export const createMatchFailure = createAction('[Matches] Create Match Failure', props<{ error: any }>());

// Update Match Actions
export const updateMatch = createAction('[Matches] Update Match', props<{ match: Match }>());
export const updateMatchSuccess = createAction('[Matches] Update Match Success', props<{ match: Match }>());
...
export const bulkUpdateMatchesSuccess = createAction('[Matches] Bulk Update Matches Success', props<{ matches: Match[] }>());
...
export const mergeMatchesSuccess = createAction('[Matches] Merge Matches Success', props<{ match: Match }>());
...
export const saveGameStatsSuccess = createAction('[Matches] Save Game Stats Success', props<{ match: Match }>());
...
export const saveManualGameStatsSuccess = createAction('[Matches] Save Manual Game Stats Success', props<{ match: Match }>());
